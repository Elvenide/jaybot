...
const ZhordeLogo = () => {
  const url = "https://zhorde.net/favicon.png";
  ...
  return (
    <Avatar
      ...
      alt="ZombieHorde"
      src={url}
      sx={{ minWidth: 50, minHeight: 50, width: 100, height: 100 }}
    >
      ZH
    </Avatar>
  );
...
const Main = ({ children }) => (
  <div
    style={{
      background: rankTheme.smoothBlack,
...
class Ranks extends Page {
  ...
  async getUsers() {
    try {
      ...
      lifetimeRanks = lifetimeRanks.concat(
        new Array(100 - lifetimeRanks.length).fill(null),
      );
      monthlyRanks = monthlyRanks.concat(
        new Array(100 - monthlyRanks.length).fill(null),
      );
      ...
      <Theme theme={rankTheme.provider}>
        <Main>
          ...
          <Section>
            ...
            >
              <RankLeaderboard
                users={isMonthly ? monthlyRanks : lifetimeRanks}
                isMonthly={isMonthly}
              />
            </Box>
          </Section>
          <Section>
            ...
            >
              Zhorde Jaybot by{" "}
              <Link
                href="https://github.com/Elvenide"
                underline="none"
                target="_blank"
                rel="noopener"
              >
